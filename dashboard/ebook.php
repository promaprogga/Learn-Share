                    ...
                    <div class="table-responsive">
                        ...
                        <form action="" method="post">
                            <table class="table table-bordered " style="color:#fff;">
                                ...
                                <thead style="background-color: #4b4b4b;color:#fff;">
                                    <tr>
                                        <th>Name</th>
                                        <th>Description</th>
                                        <th>Type </th>
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT * FROM uploads WHERE file_uploader='root' and file_uploaded_to = '$currentusercourse' AND status = 'approved' ORDER BY file_uploaded_on DESC";
                                    $run_query = mysqli_query($conn, $query) or die(mysqli_error($conn));
                                    if (mysqli_num_rows($run_query) > 0) {
                                        while ($row = mysqli_fetch_array($run_query)) {
                                            $file_id = $row['file_id'];
                                            ...
                                            echo "<td>$file_type</td>";
                                            echo "<td>$file_date</td>";
                                            echo "<td><a href='allfiles/$file' target='_blank' style='color:#fff'>Read </a></td>";
                                            echo "</tr>";
                                        }
                                    }
                                    ?>
