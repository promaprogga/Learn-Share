            ...
            <div class="row">
                <div class="col-lg-12">
                    <!-- <h1 class="page-header" style="color:#000000;">
                        Welcome
                        <small style="color:#000000;"><?php echo $_SESSION['name']; ?></small>
                                ...
                                <tbody style="color:#fff; text-align:center" >
                                    ...
                                    if (mysqli_num_rows($run_query) > 0) {
                                        while ($row = mysqli_fetch_array($run_query)) {
                                            ...
                                            echo "<td>$file_description</td>";
                                            echo "<td>$file_type</td>";
                                            echo "<td><a href='viewprofile.php?
                                    
                                            tname=$file_uploader' target='_blank' style='color:white ;'> $file_uploader </a></td>";
                                            echo "<td>$file_date</td>";
                                            echo "<td> <strong> <a href='allfiles/$file' target='_blank' style='color:white ;' color='white'>Download </a> </strong> </td>";
                                            echo "</tr>";
                                        }
                                    }
                                    ?>
