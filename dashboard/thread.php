...
<body>
   ...
   <div class="container">
        <h1 class="py-2" style="color: #fff;">Post a Comment</h1> 
        <form action="<?php echo $_SERVER["REQUEST_URI"]?>" method="post">
            <div class="form-group" >
                <label for="exampleFormControlTextarea1"style="font-size: 15px; color:#fff" >Type your comment</label>
