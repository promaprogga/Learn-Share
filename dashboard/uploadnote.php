...
<div style="background-image: url('');">
    ...
    <div class="container-fluid">
            ...
            <div class="col-lg-12">
                ...
                <form role="form" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="post_title" style="color:#fff;">Note Title</label>
                    ...
                    <div class="form-group">
                        <label for="post_tags" style="color:#fff;">Short Note Description</label>
	 ...
	 <div class=" form-group">
                        ...
                        <font color="brown" style="color:#fff;"> (allowed file type: 'pdf','doc','ppt','txt','zip' | allowed maximum size: 30 mb ) </font>
