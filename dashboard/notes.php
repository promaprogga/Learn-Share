            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        ...
                        <span style="color:#fff; text-align:center"> MY NOTES</span>
                                        ...
                                        <tbody style="color:#fff; text-align:center">
                                            ...
                                            if (mysqli_num_rows($run_query) > 0) {
                                                while ($row = mysqli_fetch_array($run_query)) {
                                                    ...
                                                    echo "<td><a onClick=\"javascript: return confirm('Are you sure you want to delete this post?')\" href='?del=$file_id' style='color: #fff;'><i class='fa fa-times' style='color: #333;'></i>delete</a></td>";
