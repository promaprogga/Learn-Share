...
<div id="page-wrapper" style="background-color: #333;" >
    ...
    <div class="container-fluid">
            ...
            <div class="col-lg-12">
                ...
                <?php
                        ...
                        if (empty($file)) {
                            ...
                            if (move_uploaded_file($_FILES['file']['tmp_name'], $folder . $notefile)) {
                                $query = "INSERT INTO uploads(file_name, file_description, file_type, file_uploader, file_uploaded_to, file,status) VALUES ('$file_title' , '$file_description' , '$fileext' , '$file_uploader' , '$file_uploaded_to' , '$notefile', '$status')";
                ...
                <form role="form" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="post_title" style="color:#fff;">Ebook Title</label>
                    ...
                    <div class="form-group">
                        <label for="post_tags" style="color:#fff;">Short Ebook Description</label>
	 ...
	 <div class=" form-group">
                        <label for="post_image" style="color:#fff;">Select File</label>
                        <font color="brown" style="color:#fff;"> (allowed file type: 'pdf','doc','ppt','txt','zip' | allowed maximum size: 500 mb ) </font>
